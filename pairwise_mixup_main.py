...
def smart_mixup(x, y, alpha=1.0, use_cuda=True, num_classes=10):
    ...
    for index in rand_index:
        ...
        if y_copy[index] == 0:
            ...
            mix_index_1 = np.concatenate(mix_index_1, np.full(num_use, index))
    ...
    mix_index_1 = np.concatenate(mix_index_1, unused_index)
    shuffle(unused_index)
    mix_index_2 = np.concatenate(mix_index_2, unused_index)
